...
<head>
<base href="<%=basePath%>">
<title>My JSP 'singleNews.jsp' starting page</title>

</head>
<link rel="stylesheet" type="text/css" href="css/singleNews.css" />
<body>
	<div id="cover"></div>
	<!-- 登录 -->
	<div id="divlogin">
	...
	<div id="divmain">
		...
		<!-- 这里的图片width为100%，不设置高  -->
		<div id="divtext">${requestScope.news.newcontent }</div>

		<div id="divdate">
			<hr style="height:1px;border:none;border-top:1px dashed gray;" />
			&nbsp&nbsp&nbsp&nbsp${requestScope.news.addtime}&nbsp${requestScope.news.author}
			<hr style="height:1px;border:none;border-top:1px dashed gray;" />
		</div>

		<!-- 评论处  -->
			<div id="divdiscuss">
				<font id="p">人参与了评论</font>
				<hr>
				<div id="divdisc">
					<!-- 评论内容 -->
				</div>
				...
				<div id="pinglun">
					<font id="p">评论</font>
					<hr>
					<div id="context" contentEditable=true tabindex = "1">
						<font color="666690" >请输入你的评论</font>
					</div>
					<div id="subm">
						<b>发表</b>
					</div>
	...
	<form id="formmm" action="" method="post">
	</form>
	<input type="hidden" id="hid1" value="${sessionScope.quser.id}">
...
<script src="js/singleNews.js" type="text/javascript"></script>
</html>
